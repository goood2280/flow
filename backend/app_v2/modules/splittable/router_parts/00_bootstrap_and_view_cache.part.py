...
# v7: VM virtual rows keep the original <step_desc>_<item_id> parameter tail;
# cached payloads built with item_id-only row names must not survive deploy.
_VIEW_DISK_CACHE_VERSION = 7

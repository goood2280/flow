...
try:
    MAX_CSV_DOWNLOAD_MAX_ROWS = max(
        500_000,
        int(os.environ.get("FLOW_MAX_CSV_DOWNLOAD_ROWS", "") or 5_000_000),
    )
except (TypeError, ValueError):
    MAX_CSV_DOWNLOAD_MAX_ROWS = 5_000_000
...
CHART_BUILDER_LIKES_FILE = "chart_builder_likes.json"
...
_CHART_BUILDER_LIKE_LOCK = threading.Lock()

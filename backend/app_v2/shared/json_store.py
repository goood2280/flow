...
class JsonFileStore:
    ...
    def __init__(self, path: Path, default, *, indent: int | None = 2):
        self.path = path
    ...
    def save(self, data) -> None:
        ...
        with lock:
            ...
            tmp.write_text(
                json.dumps(data, ensure_ascii=False, indent=self.indent, separators=(",", ":") if self.indent is None else None),
                encoding="utf-8",
            )

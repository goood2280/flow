"""Compatibility entrypoint for the split filebrowser router source."""
...
_FLOW_PARTS_DIR = _FlowPartPath(__file__).resolve().parents[1] / 'app_v2/modules/filebrowser/router_parts'

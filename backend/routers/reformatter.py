...
def schema_help():
    ...
    return {
        ...
        "metadata_fields": {
            ...
            "item_id": "raw item_id; multiple raw items can be separated by comma or / for addp",
            ...
            "addp_form": "calculation expression for addp",
        ...
        "templates": {
            ...
            "shot_formula": {"name": "DC_INDEX", "type": "shot_formula",
                              ...
                              "group_by": ["product", "root_lot_id", "lot_id", "wafer_id", "step_id", "step_seq", "shot_x", "shot_y"],

...
Linux host where the relevant /config/work/sharedworkspace child exists. On
generic Linux hosts, a missing shared DB child falls back to local data/Fab
instead of masking the working demo DB.

...
- **INLINE**: 기본 **avg**. raw의 AVG/MED/STD/MIN/MAX/Q1/Q3 요약 subitem은 재집계에서 제외한다. shot 요청은 `inline_matching.csv.matching_table`이 가리키는 TEG Inline map TABLE에 등록된 subitem만 ET shot_x/shot_y로 변환한다.

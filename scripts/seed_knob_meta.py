"""scripts/seed_knob_meta.py — Base/knob_ppid.csv + Base/step_matching.csv 샘플 생성.
...
사용:
  python scripts/seed_knob_meta.py                # default: PATHS.base_root
  python scripts/seed_knob_meta.py --force        # 기존 파일 덮어쓰기
"""
import argparse
import sys
...
def main():
    ...
    ap.add_argument("--base-root", default=None, help="대체 경로 (기본: PATHS.base_root)")
    args = ap.parse_args()

...
def scenario_list() -> list[dict[str, Any]]:
    ...
    return [
        ...
        {"name": "agent missing slot dry-run", "method": "POST", "path": "/api/llm/flowi/orchestrator/preview", "body": {"prompts": ["인폼 남겨줘"], "context": {"ask_llm_to_guess_missing": True}}, "expect_status": 200, "assertions": [{"path": "rows", "min_len": 1}]},
        ...
        {"name": "agent prompt review", "method": "POST", "path": "/api/agent/prompt-review", "body": {"prompt": "인폼 남겨줘"}, "expect_status": 200, "assertions": [{"path": "review.improved_prompt", "truthy": True}]},
        {"name": "agent prompt review fallback shape", "method": "POST", "path": "/api/agent/prompt-review", "body": {"prompt": "A1000 #6 어디야"}, "expect_status": 200, "assertions": [{"path": "llm", "type": "dict"}, {"path": "review.ambiguous_questions", "type": "list"}]},
        ...
        {"name": "agent SplitTable route", "method": "POST", "path": "/api/llm/flowi/agent/chat", "body": {"prompt": "{split_product_clean} A1002 24.0 SORT KNOB 구성이 어떻게돼?", "source_ai": "scenario", "max_rows": 3}, "expect_status": 200, "assertions": [{"path": "trace.steps", "type": "list"}]},
        ...
        {"name": "filebrowser sql draft", "method": "POST", "path": "/api/filebrowser/sql/llm/draft", "body": {"natural_language": "lot_id가 A1000인 행", "columns": ["lot_id", "wafer_id", "step_id"], "sample_rows": [{"lot_id": "A1000", "wafer_id": "1", "step_id": "AA200000"}]}, "expect_status": 200, "assertions": [{"path": "ok", "equals": True}]},

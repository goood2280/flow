...
대상 파일:
  - 현재 파일탐색기 DB 루트의 ML_TABLE_PRODA.parquet
  - 현재 파일탐색기 DB 루트의 ML_TABLE_PRODB.parquet
  - 현재 파일탐색기 DB 루트의 ET_DVC.csv / speed.csv / pred.csv
...
def main():
    ...
    print(f"\nDone. Root map saved to {BASE / '_root_map.json'}")
    print("Sample:")

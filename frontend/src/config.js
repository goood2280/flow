...
export const TABS = [
  ...
  {key:"lotmanage",label:"랏 관리",icon:"🏷️",group:"data",defaultTab:true},
  {key:"ramcache",label:"캐시 관리",icon:"🧠",group:"data"},
  {key:"matchfill",label:"매칭 채우기",icon:"🧩",group:"data"},
  {key:"diagnosis",label:"에이전트",icon:"🤖",group:"tool",defaultTab:true},
  {key:"chartbuilder",label:"차트생성",icon:"📈",group:"tool",defaultTab:true},
  {key:"templatereport",label:"Template Report",icon:"🖼️",group:"tool",defaultTab:true},
  {key:"autoreport",label:"Auto report",icon:"📑",group:"tool",defaultTab:true},
  {key:"lotrequest",label:"랏 배정/요청",icon:"📨",group:"tool",defaultTab:true},
  {key:"valve",label:"매칭알람",icon:"🚨",group:"tool"},
  {key:"teg",label:"TEG 위치 조회",icon:"📐",group:"tool"},
  {key:"yieldmap",label:"Yield Map",icon:"◫",group:"tool"},
  ...
  {key:"dcop",label:"양산DCOP 검사",icon:"✅",group:"tool"},

...
const ALL_TABS=["flowi","filebrowser","dashboard","chartbuilder","templatereport","autoreport","lotrequest","splittable","lotmanage","ramcache","matchfill","diagnosis","tracker","valve","inform","meeting","calendar","teg","ettime","reformatize","dcop"];
const BULK_GRID_COLUMNS=[
  {key:"name",label:"name"},
  {key:"username",label:"username"},
];
const BULK_GRID_HEADER_ALIASES={name:"name",이름:"name",username:"username",아이디:"username",id:"username"};
const CANONICAL_PAGE_IDS=["filebrowser","dashboard","chartbuilder","templatereport","autoreport","lotrequest","splittable","lotmanage","tracker","valve","inform","meeting","calendar","tablemap","groups","messages","diagnosis","dcop"];

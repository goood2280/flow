  ...
  return (
    <div style={wrap}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
        <div>
          <span style={{ fontSize: 13, fontWeight: 700, color: "var(--accent)" }}>AWS 설정 (멀티 프로파일)</span>
      ...
      {form && <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px 14px" }}>
        ...
        <div style={{ gridColumn: "1 / 3" }}>
          ...
          <div style={{ display: "flex", gap: 6 }}>
            ...
            {!secretEdit
              ? <button onClick={() => { setSecretEdit(true); setForm(f => ({ ...f, aws_secret_access_key: "" })); }} style={{ padding: "6px 14px", borderRadius: 5, border: "1px solid var(--border)", background: "transparent", color: "var(--text-secondary)", fontSize: 11, cursor: "pointer" }}>편집</button>
      ...
      <div style={{ marginTop: 14, padding: 12, background: "var(--bg-primary)", borderRadius: 6, fontSize: 10, color: "var(--text-secondary)", lineHeight: 1.6, fontFamily: "monospace" }}>

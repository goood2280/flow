import{r as p,j as e}from"./index-Bl42vw6s.js";const a="'JetBrains Mono',monospace";function t({children:o}){return e.jsx("pre",{className:"flow-fixed",style:{background:"#171717",borderRadius:8,padding:"14px 18px",border:"1px solid #333",overflow:"auto",fontFamily:a,fontSize:14,lineHeight:1.8,color:"#e5e5e5",whiteSpace:"pre",margin:"12px 0"},children:o})}function s({children:o,id:d}){return e.jsxs("h2",{id:d,style:{fontSize:16,fontWeight:700,color:"var(--accent,#f97316)",marginTop:36,marginBottom:14,paddingBottom:6,borderBottom:"1px solid var(--border,#333)",fontFamily:a},children:[e.jsxs("span",{style:{color:"var(--text-secondary)"},children:[">"," "]}),o]})}function i({method:o,path:d,desc:c}){const n={GET:{fg:"var(--ok)",bg:"var(--ok-50)"},POST:{fg:"var(--brand)",bg:"var(--brand-50)"},DELETE:{fg:"var(--danger)",bg:"var(--danger-50)"}}[o]||{fg:"var(--text-secondary)",bg:"var(--bg-tertiary)"};return e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,padding:"8px 0",borderBottom:"1px solid var(--border,#222)",fontSize:14},children:[e.jsx("span",{style:{fontFamily:a,fontSize:14,fontWeight:700,padding:"2px 8px",borderRadius:4,minWidth:44,textAlign:"center",background:n.bg,color:n.fg},children:o}),e.jsx("span",{style:{fontFamily:a,color:"var(--text-primary)",minWidth:300},children:d}),e.jsx("span",{style:{color:"var(--text-secondary)"},children:c})]})}function r({file:o,prefix:d,desc:c}){return e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,padding:"7px 0",borderBottom:"1px solid var(--border,#222)",fontSize:14},children:[e.jsx("span",{style:{fontFamily:a,color:"var(--text-primary)",minWidth:190},children:o}),e.jsx("span",{style:{fontFamily:a,color:"var(--accent,#f97316)",minWidth:200},children:d}),e.jsx("span",{style:{color:"var(--text-secondary)"},children:c})]})}const x=[{id:"arch",label:"아키텍처"},{id:"files",label:"파일 구조"},{id:"tabs",label:"탭 구성"},{id:"api",label:"API 레퍼런스"},{id:"worklog",label:"업무 이력/리치 본문"},{id:"db",label:"데이터 루트/DB"},{id:"schema",label:"표준 스키마"},{id:"flowi",label:"Flow-i 규칙"},{id:"perf",label:"대용량 운영"},{id:"ux",label:"UX 시스템"},{id:"add",label:"기능 추가"},{id:"update",label:"업데이트/배포"},{id:"theme",label:"테마 시스템"},{id:"infra",label:"인프라"}];function m(){const[o,d]=p.useState("arch"),c=l=>{var n;d(l),(n=document.getElementById(l))==null||n.scrollIntoView({behavior:"smooth",block:"start"})};return e.jsxs("div",{style:{display:"flex",minHeight:"calc(100vh - 52px)",background:"var(--bg-primary,#1a1a1a)",color:"var(--text-primary,#e5e5e5)",fontFamily:"'Pretendard',sans-serif"},children:[e.jsxs("div",{style:{width:190,padding:"20px 10px",borderRight:"1px solid var(--border,#333)",position:"sticky",top:52,height:"calc(100vh - 52px)",overflowY:"auto",flexShrink:0},children:[e.jsxs("div",{style:{fontSize:14,fontWeight:700,color:"var(--accent,#f97316)",textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:12,paddingLeft:10,fontFamily:a},children:[">"," 개발자_가이드"]}),x.map(l=>e.jsx("div",{onClick:()=>c(l.id),style:{padding:"6px 10px",borderRadius:5,cursor:"pointer",fontSize:14,marginBottom:1,fontFamily:a,background:o===l.id?"var(--accent-glow,#f9731622)":"transparent",color:o===l.id?"var(--accent,#f97316)":"var(--text-secondary,#a3a3a3)",fontWeight:o===l.id?600:400},children:l.label},l.id))]}),e.jsxs("div",{style:{flex:1,padding:"28px 36px",maxWidth:860,overflow:"auto",lineHeight:1.8,fontSize:14,color:"var(--text-secondary,#a3a3a3)"},children:[e.jsx(s,{id:"arch",children:"아키텍처"}),e.jsxs("p",{children:["flow = ",e.jsx("strong",{style:{color:"var(--text-primary)"},children:"FastAPI"})," (백엔드) + ",e.jsx("strong",{style:{color:"var(--text-primary)"},children:"React + Vite"})," (프론트엔드) + ",e.jsx("strong",{style:{color:"var(--text-primary)"},children:"Polars/DuckDB/Parquet"})," (데이터)"]}),e.jsx(t,{children:`[Browser] ──HTTP──> [FastAPI :8080]
...
df = pl.read_parquet(files).filter(
    pl.sql_expr("item_id = 'VTH' AND et_value > 0.5"))     # SQL 필터`}),e.jsxs("p",{children:[e.jsx("strong",{style:{color:"var(--text-primary)"},children:"DuckDB:"})," parquet/csv 원본 위의 in-memory read-only query engine으로만 사용합니다 (",e.jsx("code",{children:"core/duckdb_engine.py"}),"). 원본 DB 파일을 수정하거나 DuckDB database 파일로 변환하지 않습니다."]}),e.jsx(s,{id:"schema",children:"표준 스키마"}),e.jsx("p",{children:"Flow의 분석 기능과 Flow-i는 아래 contract를 기준으로만 데이터를 연결합니다. 컬럼명은 schema catalog에서 실제 존재 여부를 확인한 뒤 사용하며, 없는 컬럼은 추측하지 않습니다."}),e.jsx(t,{children:`# 공통 식별자
...
- card radius <= 8px
- dashboard/splittable/inform/tracker/admin spacing 통일`}),e.jsxs("p",{children:[e.jsx("strong",{style:{color:"var(--text-primary)"},children:"게시판형 입력:"})," 표·이미지가 필요한 업무 본문은 별도 첨부 버튼보다 ",e.jsx("code",{children:"RichBoardEditor"}),"를 사용합니다. 이미지/Excel 표 Ctrl+V, 키보드 포커스, 빈 HTML 판정, 저장 후 재표시, 메일 렌더링까지 한 흐름으로 검증합니다."]}),e.jsx(s,{id:"add",children:"새 기능 추가"}),e.jsxs("p",{children:[e.jsx("strong",{style:{color:"var(--text-primary)"},children:"1단계."})," 백엔드 라우터 생성 — 저장만 하면 서버 재시작 시 자동 로드됩니다. 라우터는 HTTP shape와 권한 확인만 담당하고, 업무 로직은 ",e.jsx("code",{children:"backend/app_v2/modules/<feature>"}),"에 domain/repository/service로 둡니다. JSON 저장은 ",e.jsx("code",{children:"app_v2.shared.json_store.JsonFileStore"}),"를 우선 사용합니다."]}),e.jsx(t,{children:`# backend/routers/myfeature.py
...
python -m pytest tests            # 백엔드 단위 테스트`}),e.jsxs("p",{style:{marginTop:12},children:["TABS에 등록되면 네비게이션은 자동으로 나타나고, PAGE_MAP에 없으면 Coming Soon이 표시됩니다. 소탭 권한이 필요하면 ",e.jsx("code",{children:"SUB_TABS"}),"와 백엔드 ",e.jsx("code",{children:"core/auth.py TAB_SUBTABS"}),"를 함께 수정합니다."]}),e.jsx(s,{id:"update",children:"업데이트/배포"}),e.jsxs("p",{children:["배포는 저장소 전체를 담은 단일 ",e.jsx("code",{children:"setup.py"})," 설치 파일로 합니다:"]}),e.jsx(t,{children:`# 1. 설치 파일 재생성 (main 체크아웃에서, worktree 금지)
...
/* JSX에서 사용 예시 */
style={{ color: "var(--accent)", background: "var(--bg-card)" }}`}),e.jsx(s,{id:"infra",children:"인프라"}),e.jsx("p",{children:e.jsx("strong",{style:{color:"var(--text-primary)"},children:"경로 관리 (core/paths.py, core/roots.py):"})}),e.jsx(t,{children:`from core.paths import PATHS
